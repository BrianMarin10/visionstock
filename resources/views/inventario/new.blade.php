...
<html lang="en">
  ...
  <x-app-layout>
    ...
    <form method="POST" action="{{ route('inventarios.store') }}">
        ...
        <input type="number" required class="form-control" id="stock" aria-describedby="nameHelp" name="stock">
        </div>
        <div class="mb-3">
        <label for="precio_compra" class="form-label">Precio Compra</label>
        <input type="number" required class="form-control" id="precio_compra" aria-describedby="nameHelp" name="precio_compra">
        </div>
        <div class="mb-3">
        <label for="precio_venta" class="form-label">Precio Venta</label>
        <input type="number" required class="form-control" id="precio_venta" aria-describedby="nameHelp" name="precio_venta">
        </div>
