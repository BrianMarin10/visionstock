                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-plus"></i> Agregar PQRS
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('pqrss.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" required class="form-control" id="fecha" aria-describedby="nameHelp" name="fecha" placeholder="Fecha PQRS">
                                </div>
                                <div class="mb-3">
                                    <label for="observacion" class="form-label">Observación</label>
                                    <input type="text" required class="form-control" id="observacion" aria-describedby="nameHelp" name="observacion" placeholder="Observación">
                                </div>
                                <div class="mb-3">
                                    <label for="solucion" class="form-label">Solución</label>
                                    <input type="hidden" class="form-control" id="solucion" aria-describedby="nameHelp" name="solucion" placeholder="Solución">
                                </div>
