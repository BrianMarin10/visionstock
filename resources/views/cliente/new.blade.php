                            ...
                            <form method="POST" action="{{ route('clientes.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" required class="form-control" id="nombre"
                                        aria-describedby="nameHelp" name="nombre" placeholder="Nombre cliente">
                                </div>
                                <div class="mb-3">
                                    <label for="apellido" class="form-label">Apellido</label>
                                    <input type="text" required class="form-control" id="apellido"
                                        aria-describedby="nameHelp" name="apellido" placeholder="Apellido cliente">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" required class="form-control" id="email"
                                        aria-describedby="nameHelp" name="email" placeholder="Email cliente">
                                </div>
                                <div class="mb-3">
                                    <label for="contrasena" class="form-label">Contraseña</label>
                                    <input type="password" required class="form-control" id="contrasena"
                                        aria-describedby="nameHelp" name="contrasena" placeholder="Contraseña cliente">
                                </div>
